...
<body onLoad="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
	<%
		...
		if (userType == null || !userType.equalsIgnoreCase("admin") && !userType.equalsIgnoreCase("faculty")) {
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<jsp:include page="pages/main_content/add/subject.jsp"></jsp:include>
					</div>
				</div>
			</div>
		</div>
