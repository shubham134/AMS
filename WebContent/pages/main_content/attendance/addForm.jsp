	...
	<div class="container" style="width: 100%; padding-top: 20px;">
		<div class="panel panel-primary" style="border-radius: 0">
			<div class="panel-heading" style="border-radius: 0">
				<h4 align="center">TAKE ATTENDANCE</h4>
			</div>
			...
			<div class="panel-body">
				<form action="AddAttendanceForm" method="post">
					...
					<div class="form-group">
						<div class="control-label">
							<label>Branch<font color="red" style="font-weight: lighter;">*</font></label>
						</div>
					...
					<div class="form-group">
						<div class="control-label">
							<label>Section<font color="red" style="font-weight: lighter;">*</font></label>
						</div>
						<select required class="form-control" style="border-radius: 0"
							name="section">
							<option value="" selected disabled>Select</option>
					...
					<button type="submit" class="btn btn-primary"
						style="border-radius: 0">Next</button>
