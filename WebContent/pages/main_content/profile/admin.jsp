...
<%
	...
	if(uid!=null) {
		...
		User adminUser = udao.findUserByUid(uid);
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							...
							<td><input ng-if="data.show==true"
								...
								readonly="readonly" value="${adminUser.uname}"> <input
								required ng-if="data.show!=true"
								style="border: 1px solid gray; width: 100%" type="text"
								ng-model="data.uname"></td>
						</tr>
						<tr
							ng-init="data={show:true,uid:'${adminUser.uid}',uname:'${adminUser.uname}',pwd:'${adminUser.pwd}'}">
							<th scope="row">Password</th>
							<td><input ng-if="data.show==true"
								style="background-color: transparent; border: 0" type="password"
								readonly="readonly" value="${adminUser.pwd}"> <input
								required ng-if="data.show!=true"
								style="border: 1px solid gray; width: 100%" type="text"
